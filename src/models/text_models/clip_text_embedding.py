# VQ_Diffusion from cientgu (Not implemented - taken from GuyTevet)
...
class CLIPTextEmbedding(pl.LightningModule):
    ...
    def __init__(self, 
        ...
        self.embed_text = nn.Linear(clip_dim, clip_dim)
        print('Loading CLIP...')
    ...
    def forward(self, 
        ...
        emb = self.clip_model.encode_text(texts).float()
