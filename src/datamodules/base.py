...
class BaseTextMotionDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        # Use the getter the first time to load the datamodule
    ...
    def val_dataloader(self):
        return DataLoader(self.val_dataset, shuffle=True, **self.dataloader_options)

    def test_dataloader(self):
        return DataLoader(self.test_dataset, shuffle=True, **self.dataloader_options)
