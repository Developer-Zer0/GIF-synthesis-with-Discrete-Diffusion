...
from src.utils.diffusion.nn import mean_flat, sum_flat
from src.utils.diffusion.losses import normal_kl, discretized_gaussian_log_likelihood
...
class GaussianDiffusion:
    ...
    def training_losses(self, model, x_start, t, model_kwargs=None, noise=None, dataset=None):
        ...
        return terms, model_output, x_t              # Changed here
